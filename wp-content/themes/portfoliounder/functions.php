<?php
/**
 * portfolioUnder functions and definitions
 *
...
if ( ! function_exists( 'portfoliounder_setup' ) ) :
/**
 ...
 */
function portfoliounder_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on portfolioUnder, use a find and replace
	 * to change 'portfoliounder' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'portfoliounder', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'portfoliounder_custom_background_args', array(
 ...
 */
function portfoliounder_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'portfoliounder_content_width', 640 );
}
add_action( 'after_setup_theme', 'portfoliounder_content_width', 0 );
 ...
 */
function portfoliounder_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'portfoliounder' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'portfoliounder' ),
...
add_action( 'widgets_init', 'portfoliounder_widgets_init' );
